...
@Component({
  selector: 'app-yakutsk',
  templateUrl: './yakutsk.component.html',
  styleUrls: ['./yakutsk.component.scss']
})
export class YakutskComponent implements OnInit {
  ...
  getWeatherData() {
    fetch('https://api.openweathermap.org/data/2.5/weather?q=Yakutsk&appid=86af2ffa1ea9da4b41402b2aa26a55ca')
