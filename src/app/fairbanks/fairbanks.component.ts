...
@Component({
  selector: 'app-fairbanks',
  templateUrl: './fairbanks.component.html',
  styleUrls: ['./fairbanks.component.scss']
})
export class FairbanksComponent implements OnInit {
  ...
  getWeatherData() {
    fetch('https://api.openweathermap.org/data/2.5/weather?q=Fairbanks&appid=86af2ffa1ea9da4b41402b2aa26a55ca')
