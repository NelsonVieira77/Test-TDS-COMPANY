...
@Component({
  selector: 'app-recife',
  templateUrl: './recife.component.html',
  styleUrls: ['./recife.component.scss']
})
export class RecifeComponent implements OnInit {
  ...
  getWeatherData() {
    fetch('https://api.openweathermap.org/data/2.5/weather?q=Recife&appid=86af2ffa1ea9da4b41402b2aa26a55ca')
