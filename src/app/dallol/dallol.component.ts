...
@Component({
  selector: 'app-dallol',
  templateUrl: './dallol.component.html',
  styleUrls: ['./dallol.component.scss']
})
export class DallolComponent implements OnInit {
  ...
  getWeatherData() {
    fetch('https://api.openweathermap.org/data/2.5/weather?q=Dallol&appid=86af2ffa1ea9da4b41402b2aa26a55ca')
  ...
  setWeatherData(data) {
    ...
    if (this.weather == "Rain") {
      ...
      this.clouds = true;
      this.elementRef.nativeElement.ownerDocument.body.style.backgroundColor = '#BAC5C5';
    }
